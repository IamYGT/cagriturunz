							...
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body text-right">
										<p class="fs-18 text-white mb-2">Online Ziyaretçi</p>
										<span class="fs-48 text-white font-w600"><?php echo number_format($db->query("SELECT COUNT(DISTINCT ziyaretci_ip) FROM ziyaretciler WHERE ziyaretci_tarih LIKE '%".Date('Y-m-d')."%';")->fetchColumn()); ?></span>
									</div>
								</div>
							</div>
						</div>
