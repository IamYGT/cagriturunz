        ...
        ***********************************-->
		...
		<div class="deznav">
            <div class="deznav-scroll">
		       ...
		       <li>
						<a class="ai-icon" href="videolar" aria-expanded="false">
                    ...
                    <li>
						<a class="ai-icon" href="kurumsal2" aria-expanded="false">
							<i class="fas fa-sliders-h"></i>
							<span class="nav-text">Kurumsal Eğitim Danışmanlık</span>
						</a> 
                    </li> 
			 
		 
                    <li>
						<a class="ai-icon" href="projeler2" aria-expanded="false">
							<i class="fas fa-sliders-h"></i>
                    ...
                    <li>
						<a class="ai-icon" href="projeler" aria-expanded="false">
							<i class="fas fa-sliders-h"></i>
							<span class="nav-text">Ses Prodüksiyon</span>
						</a> 
                    </li> 
