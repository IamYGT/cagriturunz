							...
							<div id="example5_wrapper" class="dataTables_wrapper no-footer">
								<table class="table display mb-4 dataTablesCard card-table dataTable no-footer" id="example5" role="grid" aria-describedby="example5_info">
									<thead>
										...
										<th class="sorting" tabindex="0" aria-controls="example5" rowspan="1" colspan="1" aria-label="Company: activate to sort column ascending" style="width: 215.6px;">Resim 670x650</th>
...
?>
										<tr id="item-<?php echo $row["haber_ust_id"]; ?>" role="row" class="even"> 
											...
											<td class=""><?php if(isset($row["haber_resim"])){ ?><img class="mr-3 " width="60" src="../uploads/projeler/<?php echo $row["haber_resim"]; ?>" alt="<?php echo $row["haber_baslik"]; ?>"><?php }else{ ?><img class="mr-3 " width="60" src="images/no_images.png" alt="<?php echo $row["haber_baslik"]; ?>"><?php } ?></td>
											<td class=""><?php echo $row["haber_tarih"]; ?></td>
											<td class="sorting_1">
												<div class="d-flex">
												<a class="contact-icon mr-3" href="projeler?do=marka&egzoz_id=<?php echo $row["egzoz_ust_id"]; ?>"><i class="fas fa-link" aria-hidden="true"></i></a>
													...
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																...
																<input type="text" name="haber_description[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Description" required="">
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
                            ...
                            <div class="card-body p-3">  
								...
								<?php }else{?> 
										<div class="fileinput fileinput-exists" data-provides="fileinput">
											...
											<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 303px; max-height: 190px; line-height: 190px;"><img src="../uploads/projeler/<?php echo $row_info["haber_resim"]; ?>" class="img-fluid img-thumbnail"></div>
											<div>
												<span class="btn btn-primary btn-sm btn-file">
													<span class="fileinput-new"><span class="fui-image"></span>Resim Seç</span>
													<span class="fileinput-exists"><span class="fui-gear"></span>Değiştir</span>
